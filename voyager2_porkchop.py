...
dep_dates_0 = '1970-02-01'         # Intial departure date
dep_dates_1 = '1980-11-07'         # Final departure date
arr_dates_0 = '1973-01-01'         # Initial arrival date
arr_dates_1 = '2000-01-01'          # Final arrival date 
...
planet1 = 'Saturn'
departure_planet, arrival_planet = loop_bodies(planet0, planet1)
dep_dates_2_i =  "1973-01-01"
dep_dates_2_f = "2000-01-01"
arr_dates_2_i = "1976-01-01"
arr_dates_2_f = "2005-01-01"
...
dep_dates_3_i =  "1976-01-01"
dep_dates_3_f = "2005-01-01"
arr_dates_3_i = "1980-01-01"
arr_dates_3_f = "2010-01-01"
...
dep_dates_4_f = "2010-01-01"
arr_dates_4_i = "1983-01-01"
arr_dates_4_f = "2014-01-01"
...
c3_levels_0 = np.arange(10, 300, 30)
c3_levels_1 = np.arange( 50, 500, 50)
c3_levels_2 = np.arange( 10, 500, 40)
...
for i in range(n_plots):
    ...
    if i % 2 == 0:
        ...
        if i == 0:
            ax.axvline(x = 2757, color='red', linestyle='--')
            ax.axhline(y = 2380, color='red', linestyle='--')
        
        elif i == 2:
            ax.axvline(x = 2063, color='red', linestyle='--')
            ax.axhline(y = 2169, color='red', linestyle='--')
        else:
            pass
