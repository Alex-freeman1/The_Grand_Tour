...
dep_dates_4_f = "2013-01-01"
arr_dates_4_i = "2010-01-01"
arr_dates_4_f = "2049-01-01"
...
for i in range(n_plots):
    ...
    if i % 2 == 0:
        ...
        y_end = ax.get_ylim()[1]
        if i == 0:
            ax.plot([2000, x_end], [2120, 2120], color='red', linestyle='--')
            ax.plot([2000, 2000], [2120, y_end], color='red', linestyle='--')
            plt.plot(2000, 2120, marker='^', color='red')
        
        if i == 2:
            ax.plot([3510, x_end], [6630, 6630], color='red', linestyle='--')
            ax.plot([3510, 3510], [0, 6630], color='red', linestyle='--')
            plt.plot(3510, 6630, marker='^', color='red')
            
        if i == 4:
            #ax.plot([3400, x_end], [6200, 6200], color='red', linestyle='--')
            ax.plot([8000, 8000], [0, 13500], color='red', linestyle='--')
            plt.plot(8000, 13500, marker='^', color='red')
    ...
    # Odd plots: rotated and flipped
        ...
        y_end = ax.get_ylim()[1]
        if i == 1:
            ax.plot([0, 3510], [2120, 2120], color='red', linestyle='--')
            ax.plot([3510, 3510], [2120, y_end], color='red', linestyle='--')
            plt.plot(3510, 2120, marker='^', color='red')

            
        if i == 3:
            ax.plot([0, 8000], [6630, 6630], color='red', linestyle='--')
            ax.plot([8000, 8000], [6630, y_end], color='red', linestyle='--')
            plt.plot(8000, 6630, marker='^', color='red')
         
        
        ax.text(
            0.5, -0.18, f"Segment {segment_names[i]}",
